...
if __name__ == "__main__":
    ...
    ap.add_argument("--input", required=True, help="Path to CSV/Parquet with a smiles column")
    ...
    write_scaffold_splits(
        df=df, smiles_col=args.smiles_col, out_dir=args.out_dir, fmt=args.format,
        train_frac=args.train, val_frac=args.val, seed=args.seed
    )
