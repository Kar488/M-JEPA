...
if _has_utils and "roc_auc" in df.columns:
    df_plot = df.copy()
    ...
    labels = [f"{r['gnn_type']}/{r['hidden_dim']}/{r['mask_ratio']}/{int(r['add_3d'])}"
    ...
    print("Saved", outdir / "tiny_grid_bar.png")
print("Done.")
